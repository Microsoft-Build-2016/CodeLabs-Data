...
namespace Common
{
    ...
    public static class Argument
    {
        ...
        public static void CheckStringNullOrLength([ValidatedNotNull]string argument, string argumentName, int maxLength)
        {
            ...
            {
                throw new ArgumentException("The length of {0} exceeds {1} characters".FormatWith(argumentName, maxLength), argumentName);
            }
        }
        ...
        public static void CheckNullEmptyOrLength<T>([ValidatedNotNull] IEnumerable<T> argument, string argumentName, int maxLength)
        {
            ...
            {
                throw new ArgumentException("The length of {0} exceeds {1}".FormatWith(argumentName, maxLength), argumentName);
            }
        }
